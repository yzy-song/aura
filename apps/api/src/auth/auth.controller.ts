...
export class AuthController {
  ...
  @Post('link-firebase')
  @ApiOperation({ summary: 'Link an anonymous profile to a Firebase account' })
  async linkFirebase(@ProfileId() profileId: string | null, @Body() firebaseLoginDto: FirebaseLoginDto) {
    return this.authService.firebaseLogin(firebaseLoginDto.idToken, profileId);
  }
}
